...
public class Explore extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    ListView listview_tracks, listview_search;
    ProgressBar progressBarInitial;
    Toolbar toolbar;
    Singering_Database db;
    AdmobExpressAdapterWrapper adapterWrapper;
    SearchView sv;
    FrameLayout frame_search, frame_check;
    RequestParams requestParams;
    ArrayList<Explore_model_item> search_list = new ArrayList();
    ...
    private void get_data(String search) {
        ...
        requestParams.add("t-search", search);

        //  final ProgressDialog pDialog = new ProgressDialog(Search_userprofl.this);

        client.post(this, Station_Util.URL + "push.php?request=track", requestParams, new JsonHttpResponseHandler() {
            @Override
            public void onStart() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if (response.getString(KEY_SUCCESS) != null) {
                        ...
                        if (Integer.parseInt(res) == 1) {
                            JSONArray array = response.getJSONArray("search-track");
                            Log.e("Arraylist size", "" + array.length());
                        ...
                        Toast.makeText(Explore.this, "No result found", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                list_Adapter = new Explore_Tracks_Adapter(getApplicationContext(), CircleActivity.adapter_data, 0, false);
                ...
                if (getResources().getBoolean(R.bool.Ads_check) == true) {
                    initListViewItems_two();
                } else {
                    listview_search.setAdapter(list_Adapter);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                //  pDialog.dismiss();
                Toast.makeText(Explore.this, "Error", Toast.LENGTH_LONG).show();
            }
    ...
    private void initListViewItems_two() {
        ...
        adapterWrapper.setNoOfDataBetweenAds(10);
        adapterWrapper.setFirstAdIndex(3);
        listview_search.setAdapter(adapterWrapper); // setting an AdmobAdapterWrapper to a ListView
        adapterWrapper.notifyDataSetChanged();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Object o = listview_search.getItemAtPosition(position);
        try {
