...
/**
 * Created by ST_004 on 25-01-2017.
 */

public class Adapter_recent_recycler extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Adapter_recent_recycler(Context context) {
        mContext = context;
    }
