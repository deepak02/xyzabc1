 ...
 */
public class Search_Adapter extends ArrayAdapter<Search_model_item> {
    Context mcontext;
    public List<Search_model_item> tracks = new ArrayList<>();
    ...
    public Search_Adapter(Context context, ArrayList<Search_model_item> tracks) {
        super(context, R.layout.search_item_view, tracks);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || convertView.getTag().equals(TAG_TOP)) {
            ...
            convertView = inflater.inflate(R.layout.search_item_view, parent, false);
